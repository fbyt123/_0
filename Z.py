...
os.system(f"ffmpeg -http_persistent 0 -ss 00:00:00 -re -i '{pr}' -map 0:p:5 -c:v libx264 -c:a aac -g 48 -preset ultrafast -tune zerolatency -f flv rtmp://a.rtmp.youtube.com/live2/43ys-88cy-7e3t-khew-3csa")
